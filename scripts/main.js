...
jQuery(document).ready(function (t) {
    ...
    function n(e, n) {
        ...
        a.clearRect(0, 0, o.width(), o.height()), a.beginPath(), a.moveTo(0, o.height()), a.lineTo(o.width(), o.height()), a.lineTo(o.width(), 0), a.lineTo(o.width(), t(window).height - 0.8 * n), a.bezierCurveTo(.9 * (wh - o.height()), 0, wh - o.height(), n, .1 * -n, o.height()), a.closePath(), 'undefined' != typeof o.data('image')) {
            var h = new Image();
            h.src = o.data('image');
...
$(document).ready(function () {
    ...
    if (k) $(window).on('scroll load', function (i) {
        //console.log(s, e);
        if (p) $(this).unbind(i);else {
    ...
    var showNumber = function showNumber(target, number, symbol, start, interval) {
        if (start < number) {
...
$(document).ready(function () {
    ...
    if (t) $(window).on('scroll load', function (i) {
        //console.log(s, e);
        if (n) $(this).unbind(i);else {
            var s = $(this).height() + $(this).scrollTop(),
                e = t.offset().top;
            if (s >= e) {
                n = !0;
...
$(document).ready(function () {
    if ($('#main_page').length && $(window).width() >= 992) {
        ...
        //.addIndicators()
        .setClassToggle('#mb-tittle', 'transition-reset').setClassToggle('#mb-slider-count', 'transition-reset').addTo(wcontroller).on('progress', function (e) {
        ...
        //.addIndicators()
        .addTo(wcontroller).on('progress', function (e) {
            if ($(window).width() >= 992) {
                ...
                if (e.progress.toFixed(2) < 0.15) $(gsliderC).hide();else $(gsliderC).show();
                if (e.progress.toFixed(2) < 0.16) $(gsliderC).css({ 'opacity': '0' });else $(gsliderC).css({ 'opacity': '1' }).show();
            } else {
        ...
        .addTo(wcontroller).on('progress', function (e) {
            ...
            if ($(window).width() >= 992) {
                ...
                if (e.progress.toFixed(2) < 0.15) $('#bp_technology > .container').css({ 'opacity': '0' });else {
        ...
        //.addIndicators()
        .addTo(wcontroller).on('enter', function (e) {
            $('#jform').fadeIn(400);
            $('input#jname').focus();
        }).on('leave', function (e) {
            $('#jform').fadeOut(400);
    ...
    if ($('#aboutpath').length) {
        ...
        }).setClassToggle('#pathdot_1', 'hvr-ripple-out-path').addTo(controller).on('progress', function (e) {
...
$(document).ready(function () {
    ...
    if ($('#map').length) {
        ...
        $('#mwarszawa').on('click', function () {
            bpmap.setCenter(warszawa.lat, warszawa.lng);
            bpmap.hideInfoWindows();
            mwarszawa.setAnimation(google.maps.Animation.DROP);
        });
        $('#mszczecin').on('click', function () {
            bpmap.setCenter(szczecin.lat, szczecin.lng);
            bpmap.hideInfoWindows();
